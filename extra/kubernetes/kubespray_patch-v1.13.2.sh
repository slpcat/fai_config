...
cd kubespray
git checkout e3ffa2130361ee03102db8b727630a9d313da32d
cd ..
...
sed -i 's/^kube_version.*$/kube_version:\ v1.13.2/' ./kubespray/inventory/sample/group_vars/k8s-cluster/k8s-cluster.yml
...
#change download url
sed -i 's/^hyperkube_download_url.*$/hyperkube_download_url:\ \"https:\/\/github.com\/slpcat\/fai_config\/raw\/master\/extra\/kubernetes\/k8s-release\/v1.13.2\/hyperkube\"/' ./kubespray/roles/download/defaults/main.yml
sed -i 's/^kubeadm_download_url.*$/kubeadm_download_url:\ \"https:\/\/github.com\/slpcat\/fai_config\/raw\/master\/extra\/kubernetes\/k8s-release\/v1.13.2\/kubeadm\"/' ./kubespray/roles/download/defaults/main.yml
