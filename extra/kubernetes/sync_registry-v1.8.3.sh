#!/bin/bash
#sync all images for kubernetes v1.8.3 to private registry
set -o errexit
set -o nounset
set -o pipefail
...
images=(
cluster-proportional-autoscaler-amd64:1.1.1
...
images=(
coreos/hyperkube:v1.8.3_coreos.0
coreos/etcd:v3.2.4
...
docker pull registry.cn-hangzhou.aliyuncs.com/google_containers/tiller:v2.7.0
docker tag registry.cn-hangzhou.aliyuncs.com/google_containers/tiller:v2.7.0 slpcat/tiller:v2.7.0
docker push slpcat/tiller:v2.7.0
docker rmi slpcat/tiller:v2.7.0
